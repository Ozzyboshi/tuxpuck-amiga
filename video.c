...
/**Loads a png type image.*/
SDL_Surface *video_create_png_surface(Uint8 * data, Uint32 * memcounter)
{
  return loadPNG(data, memcounter);
}

/* Loads a JPG Type image and returns it as an SDL Surface.
 *
 * @param data jpeg type of image.
 *
 * @return SDL_Surface representing that jpeg image.
 */
