...
#ifndef windows
	//homeDir = getenv("HOME");
	sprintf(_settings_file, "tuxpuckrc");
#endif
#ifdef _DEBUG
	printf("Preparing to read settings\n");
#endif
	//_read_settings();
#ifdef _DEBUG
	printf("Read settings done audio is at %d\n",_settings->sound);
#endif
	//audio_set_mute(!_settings->sound);
#ifdef _DEBUG
	printf("Audio set mute done\n");
#endif
	if (_settings->fullscreen)
		video_toggle_fullscreen();
#ifdef _DEBUG
	printf("Video toggle fullscreen done\n");
#endif
	run_intro();
#ifdef _DEBUG
	printf("Run intro done\n");
#endif
	video_save();
#ifdef _DEBUG
	printf("Video save done");
...
#ifdef _DEBUG
	printf("Starting menu create(3)\n");
#endif
	Menu* main_menu = menu_create(3);
#ifdef _DEBUG
	printf("menu create(3) done\n");
#endif
...
#ifdef _DEBUG
	printf("Create game menu OK!\n");
#endif
	opponent_menu = create_opponent_menu();
#ifdef _DEBUG
	printf("Create opponent menu OK!\n");
#endif
	option_menu = create_option_menu();
#ifdef _DEBUG
	printf("Create option menu OK!\n");
#endif
	int loop = 1;
